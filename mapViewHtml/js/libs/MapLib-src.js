/*
	ES.MapLib 2.3.0, a js library for exsun lbs instance.
	(c) 2016-2018, liulin
	武汉依迅
	http://www.exsun.cn/
*/
...
L.MapLib.MapControl.ESMapSearch = L.Evented.extend({
    ...
    oOption: {
        ...
        title: '图层切换',
        // poi 查询地址
        cUrl: m_cHost + '/base/poi',

        // 具体参数含有可以查看高德MapApi
        oParam: {
            actiontype: 'PoiSearch',
            key: '',
            keywords: '',
            types: '050301',
    ...
    initToolEvent: function () {
        ...
        this.$_oInput.keyup(function (e) {
            ...
            bTo = setTimeout(function () {
                ...
                ES.getData(oParam, self.oOption.cUrl, self.searchPoiHandler, this, null,
                    {
                        headers: {
