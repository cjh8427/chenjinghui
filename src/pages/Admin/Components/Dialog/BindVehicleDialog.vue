      ...
      <el-container style="height: 500px; border: 1px solid #eee">
        ...
        <div class="ex-table-content dialog" style="width: 49%">
          ...
          <div class="ex-table-query">
            <el-form :inline="true" :model="dialogGridData" size="mini">
              <el-form-item label="车牌号">
                <el-input v-model="dialogGridData.title" placeholder="请输入您要查询的车牌号"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" @click="queryDialogGridData">
          ...
          <div class="ex-table-container">
            <el-table :data="tableData" height="440">
              ...
              <el-table-column prop="name" label="所属机构" align="center"></el-table-column>
            </el-table>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    handleCancel() {
      this.$emit("bindVehicleCallBack", false);
    },
    handleSave() {
      this.$emit("bindVehicleCallBack", false);
    },
