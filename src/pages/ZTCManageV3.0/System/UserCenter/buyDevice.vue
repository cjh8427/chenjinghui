<template>
    <div class="wrapper">
        ...
        <ul class="platformDetial">
            <li class="platformDetialItem">
                ...
                <div class="itemContent">
                    <div v-for="(item,index) in platList" :class="item.class" @click="changeColor(item.id,index)" :key="index"><span>{{item.name}}</span></div>
                </div>
            </li>
            <li class="platformDetialItem">
            ...
            <li class="platformDetialItem" v-show="isDeviceMjShow">
                <div class="itemTxt"> <el-checkbox style="width: auto"></el-checkbox>附加门禁设备</div>
                <div class="itemContent deviceItemWrapper">
            ...
            <li class="platformDetialItem" v-show="isDeviceYcShow">
                <div class="itemTxt"><el-checkbox style="width: auto"></el-checkbox>附加扬尘噪音有害气体设备</div>
                <div class="itemContent deviceItemWrapper">
                ...
                <div class="itemContent" >
                    <el-form  label-width="100px" :model="receiveForm">
                        <el-form-item label="名称">
                            <el-input v-model="receiveForm.name" placeholder="请输入"></el-input>
                        </el-form-item>
                        <el-form-item label="活动区域">
                            <el-input v-model="receiveForm.region" placeholder="请输入"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
            </li>
            <li class="platformDetialItem">
                <div class="itemTxt">收货地址 <el-button type="info" size="small" style="float:right;" @click="handleAdd()">新增</el-button></div>
                <div class="itemContent">
                    <div class="receiverAddressWrapper">
                      <el-tag class="receiverAddress" :key="tag" v-for="tag in dynamicTags" closable :disable-transitions="false" @close="handleClose(tag)">
                         <ul>
        ...
        <el-dialog title="新增收货地址" :visible.sync="dialogFormVisible" width="40%" left="30%" top="15%">
            <el-form :model="addressForm" label-width="100px">
                <el-form-item label="收货人" >
                    <el-input v-model="addressForm.name" autocomplete="off"  size="small"></el-input>
                </el-form-item>
                <el-form-item label="联系电话" >
                    <el-input v-model="addressForm.name" autocomplete="off"  size="small"></el-input>
                </el-form-item>
                <el-form-item label="所在区域">
                    <el-select v-model="addressForm.region" size="small" style="width: 100%;" placeholder="请选择活动区域">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="info" @click="submitAddressForm" size="small">确 定</el-button>
            </div>
        </el-dialog>
    </div>
